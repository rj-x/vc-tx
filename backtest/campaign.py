...
def main(slugs=(SLUG, "uk100")):
    ...
    generate_report()
    # results front page (register 58): regenerated by every Part C run;
    # contains no number that isn't in a stamped artifact
    from backtest.dashboard import main as _dash
    _dash()
