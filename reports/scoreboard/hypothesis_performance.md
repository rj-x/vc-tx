...
Engine `860f648b9` — register 40 fence as amended 2026-08-19 (operator): one section per instrument, each computed only from that instrument's own store and native calendar; uk100 canonical, ger40/nas100/us30 PROVISIONAL (validation pending). Numbers are NEVER pooled across instruments — cross-instrument aggregation is a future registration. This first cross-instrument read is EXPLORATORY: expectations deliberately unregistered; anything interesting becomes a pre-registered question before it becomes a claim.

---

# uk100 (uk100fut) — CANONICAL

Store span (1M, close ts): 2026-07-12 22:06:00+00:00 → 2026-08-21 18:47:00+00:00. Volume type: real futures volume (step-zero audit).

## Summary Matrix (page 1)

Engine `860f648b9` — OBSERVATIONAL signal scoreboard - move-detection, not trading; no fills exist here by construction; never validation (docs/hypothesis_lifecycle.md stage 4)
...
|---|---|---|---|---|---|
| *context* | | 181 ep; chance 23.6%dir/44.4%either | 52 ep; chance 24.9%dir/47.2%either | 52 ep; chance 24.5%dir/44.7%either | 12 ep; chance 28.1%dir/53.4%either |
| S0-H1 | keep-watching | ▲i+9.0pp (23/69) · p+1.0pp cap38.8 net+194/med+2.8 | ▲i+5.8pp (7/22) · p+11.5pp cap38.5 net+133/med+3.0 | ▲i+7.3pp (14/49) · p-4.1pp cap12.7 net-4/med-0.7 | (°▲i+26.6pp (6/13) · p-12.7pp cap26.2 net-3/med-1.2) |
| S1-H1 | keep-watching | (°▼i-4.3pp (1/5) · p-3.6pp cap59.3 net+9/med+3.0) | — | (°▲i+3.7pp (1/4) · p+0.5pp cap33.0 net+7/med-1.6) | (°▲i+13.7pp (1/3) · p+5.2pp cap33.0 net+28/med+10.5) |
| S0-H2 | promote-candidate | ·i-0.4pp (83/347) · p+1.2pp cap34.8 net+781/med+1.5 | ▼i-3.5pp (18/80) · p+6.3pp cap40.0 net+521/med+9.2 | ▼i-3.1pp (28/154) · p+2.8pp cap13.1 net-22/med-0.7 | ▼i-3.7pp (7/44) · p-5.4pp cap28.0 net-14/med-1.2 |
| S1-H2 | promote-candidate | ·i+0.3pp (62/252) · p+0.6pp cap34.2 net+540/med+0.9 | ·i+1.1pp (16/59) · p+5.6pp cap39.0 net+559/med+12.0 | ▼i-3.7pp (23/131) · p+4.5pp cap13.1 net-9/med-0.8 | ·i+0.4pp (7/35) · p-5.2pp cap28.9 net-15/med-1.8 |
| S0-H3 | keep-watching | — | — | (°·i-1.3pp (2/10) · p+15.5pp cap7.0 net-14/med+0.3) | (°▲i+13.7pp (1/3) · p+5.2pp cap19.5 net-24/med-5.0) |
| S0-H4 | keep-watching | (°▲i+18.6pp (3/7) · p-23.6pp cap— net+14/med+0.5) | (°▼i-26.0pp (0/1) · p-24.9pp cap— net+6/med+5.5) | — | — |
| S0-H5 | keep-watching | — | — | — | — |
| S0-H6 | keep-watching | ·i-1.7pp (8/59) · p+8.2pp cap33.8 [cls 37.6%/15.3%i] net+391/med+5.7 | ·i+1.4pp (4/31) · p+20.7pp cap32.9 [cls 37.4%/11.5%i] net+282/med+16.0 | ▲i+3.1pp (4/25) · p+14.1pp cap19.6 [cls 41.9%/12.9%i] net+147/med+5.8 | (°▲i+6.1pp (3/17) · p+19.6pp cap18.2 [cls 39.2%/11.5%i] net+104/med+5.8) |
| S0-H7 | keep-watching | ▲i+8.7pp (37/112) · p+5.9pp cap32.0 net+7/med+2.8 | ▲i+15.5pp (17/41) · p+1.9pp cap32.0 net-217/med+2.7 | ▼i-9.4pp (5/42) · p+6.5pp cap23.2 net+102/med+2.1 | (°▼i-14.3pp (1/19) · p+8.7pp cap24.2 net+4/med-1.0) |
| S0-H7 (either-dir) | keep-watching | ·i+0.0pp (49/112) · p+7.4pp cap15.8 | ▲i+7.2pp (22/41) · p+1.6pp cap20.0 | ▼i-8.8pp (13/42) · p+0.5pp cap19.7 | (°▼i-11.5pp (5/19) · p+4.5pp cap20.0) |
| S0-H8 | keep-watching | ▼i-2.9pp (142/347) · p+1.7pp cap17.3 | ▼i-15.3pp (25/80) · p+5.3pp cap34.5 | ▼i-5.4pp (53/154) · p+2.7pp cap7.6 | ·i-1.4pp (16/44) · p-5.7pp cap10.5 |
| S0-H9 | keep-watching | ▲i+4.8pp (16/55) · p+3.7pp cap37.2 net+319/med+3.5 | (°▼i-16.9pp (1/11) · p+20.6pp cap45.0 net+108/med+12.5) | (°▲i+28.7pp (7/14) · p-17.4pp cap16.0 net-18/med-3.1) | — |
| S1-H9 | keep-watching | (°▼i-13.8pp (2/19) · p+23.8pp cap45.0 net+263/med+12.8) | (°▼i-26.0pp (0/8) · p+25.1pp cap57.1 net+148/med+17.8) | (°▲i+3.7pp (1/4) · p-24.5pp cap— net-10/med-2.2) | — |
| S0-H10 | deprioritize | ▼i-8.9pp (45/293) · p-4.5pp cap27.1 net-240/med-1.4 | ▼i-13.9pp (8/66) · p+2.4pp cap33.2 net-62/med+1.9 | ·i+1.9pp (22/95) · p-15.0pp cap12.7 net-246/med-3.0 | (°▼i-11.3pp (1/12) · p-11.4pp cap21.5 net+27/med+4.8) |
| S0-H11 | keep-watching | ▲i+2.9pp (86/316) · p+2.3pp cap32.6 net-647/med-2.4 | ▲i+3.1pp (43/148) · p-1.3pp cap35.0 net+250/med-0.6 | ·i-1.9pp (13/67) · p-0.6pp cap16.7 net+178/med+3.2 | ▼i-7.5pp (4/33) · p-12.9pp cap20.7 net+157/med+4.8 |
| S0-H12 | keep-watching | — | — | — | — |
| S0-H13 | keep-watching | (°▲i+25.7pp (1/2) · p+26.4pp cap37.0 net+28/med+13.8) | (°▲i+24.0pp (1/2) · p+25.1pp cap37.0 net+28/med+13.8) | (°▼i-21.3pp (0/3) · p+8.8pp cap6.7 net-33/med-6.1) | — |
| **union coverage** | | 55.8% (101/181) | 53.8% (28/52) | 86.5% (45/52) | 91.7% (11/12) |
...
| H2 forward (S0-H2) | us30fut/forward | 17.9% (40/224) | 27.7% (cap 67.8) |
| H2 forward (S1-H2) | uk100fut/forward | 17.6% (23/131) | 29.0% (cap 13.1) |
| H2 forward (S1-H2) | ger40fut/forward | 25.7% (26/101) | 28.7% (cap 33.1) |
...
| S0-H8 (either-dir) | us30fut/forward | 33.9% (76/224) | 49.1% (cap 42.5) |
...
| S0-H6 (conditioned) | us30fut/forward | 21.3% (10/47) | 40.4% (cap 88.5) |
...
|---|---|---|
| whole | ▲i+9.0pp (23/69) · p+1.0pp cap38.8 net+194/med+2.8 | ▲i+7.3pp (14/49) · p-4.1pp cap12.7 net-4/med-0.7 |
...
| ny_only | ▲i+19.6pp (9/22) · p+8.0pp cap46.9 net+17/med+1.6 | (°▼i-15.9pp (0/12) · p-6.0pp cap— net+8/med+0.9) |
...
- forward payoff: right +160 / wrong -164 / net -4 pts; median per fire -0.70 (n=49)
...
| session | backtest | forward |
|---|---|---|
| whole | (°▼i-4.3pp (1/5) · p-3.6pp cap59.3 net+9/med+3.0) | (°▲i+3.7pp (1/4) · p+0.5pp cap33.0 net+7/med-1.6) |
...
| session | backtest | forward |
|---|---|---|
| whole | ·i-0.4pp (83/347) · p+1.2pp cap34.8 net+781/med+1.5 | ▼i-3.1pp (28/154) · p+2.8pp cap13.1 net-22/med-0.7 |
...
| ny_only | ▼i-3.1pp (10/55) · p+4.3pp cap40.8 net-487/med-2.5 | ▼i-8.8pp (2/28) · p-6.0pp cap— net-10/med-0.8 |
...
| session | backtest | forward |
|---|---|---|
| whole | ·i+0.3pp (62/252) · p+0.6pp cap34.2 net+540/med+0.9 | ▼i-3.7pp (23/131) · p+4.5pp cap13.1 net-9/med-0.8 |
...
| ny_only | ·i-1.3pp (8/40) · p+4.8pp cap38.6 net-304/med-2.1 | ▼i-7.9pp (2/25) · p-6.0pp cap— net+0/med-0.8 |
...
| session | backtest | forward |
|---|---|---|
| whole | — | (°·i-1.3pp (2/10) · p+15.5pp cap7.0 net-14/med+0.3) |
| london | — | (°▲i+13.7pp (1/3) · p+5.2pp cap19.5 net-24/med-5.0) |
| overlap | — | — |
| ny_only | — | (°▲i+17.4pp (1/3) · p-6.0pp cap— net+3/med+0.8) |
...
| session | backtest | forward |
|---|---|---|
| whole | ·i-1.7pp (8/59) · p+8.2pp cap33.8 [cls 37.6%/15.3%i] net+391/med+5.7 | ▲i+3.1pp (4/25) · p+14.1pp cap19.6 [cls 41.9%/12.9%i] net+147/med+5.8 |
...
| ny_only | (°▲i+10.6pp (1/4) · p-20.5pp cap— [cls 20.5%/14.4%i] net+0/med+6.5) | (°▼i-5.8pp (0/2) · p-7.0pp cap— [cls 7.0%/5.8%i] net-7/med-3.4) |
...
| session | backtest | forward |
|---|---|---|
| whole | ▲i+8.7pp (37/112) · p+5.9pp cap32.0 net+7/med+2.8 | ▼i-9.4pp (5/42) · p+6.5pp cap23.2 net+102/med+2.1 |
...
| ny_only | (°·i+0.1pp (3/14) · p+4.1pp cap27.6 net-24/med+0.0) | (°▲i+17.4pp (3/9) · p-6.0pp cap— net+22/med+2.2) |
...
| session | backtest | forward |
|---|---|---|
| whole | ·i+0.0pp (49/112) · p+7.4pp cap15.8 | ▼i-8.8pp (13/42) · p+0.5pp cap19.7 |
...
| ny_only | (°▼i-16.4pp (3/14) · p+8.6pp cap13.4) | (°▲i+26.9pp (5/9) · p-12.1pp cap—) |
...
| session | backtest | forward |
|---|---|---|
| whole | ▼i-2.9pp (142/347) · p+1.7pp cap17.3 | ▼i-5.4pp (53/154) · p+2.7pp cap7.6 |
...
| ny_only | ▼i-5.1pp (18/55) · p+23.6pp cap6.9 | ▼i-18.0pp (3/28) · p-8.5pp cap-0.2 |
...
| session | backtest | forward |
|---|---|---|
| whole | ▲i+4.8pp (16/55) · p+3.7pp cap37.2 net+319/med+3.5 | (°▲i+28.7pp (7/14) · p-17.4pp cap16.0 net-18/med-3.1) |
| london | (°▼i-16.9pp (1/11) · p+20.6pp cap45.0 net+108/med+12.5) | — |
| overlap | — | (°▼i-25.8pp (0/1) · p-26.1pp cap— net-1/med-1.0) |
| ny_only | (°▲i+20.4pp (5/12) · p+14.8pp cap69.9 net+115/med+2.8) | (°▲i+34.1pp (2/4) · p+19.0pp cap16.0 net+14/med+5.2) |
...
| session | backtest | forward |
|---|---|---|
| whole | (°▼i-13.8pp (2/19) · p+23.8pp cap45.0 net+263/med+12.8) | (°▲i+3.7pp (1/4) · p-24.5pp cap— net-10/med-2.2) |
...
| session | backtest | forward |
|---|---|---|
| whole | ▼i-8.9pp (45/293) · p-4.5pp cap27.1 net-240/med-1.4 | ·i+1.9pp (22/95) · p-15.0pp cap12.7 net-246/med-3.0 |
...
| ny_only | ▼i-2.0pp (16/83) · p-0.6pp cap25.3 net+51/med-1.5 | ▼i-4.4pp (3/26) · p-2.2pp cap13.5 net-27/med-1.0 |
...
- forward payoff: right +147 / wrong -394 / net -246 pts; median per fire -3.00 (n=95)
...
| session | backtest | forward |
|---|---|---|
| whole | ▲i+2.9pp (86/316) · p+2.3pp cap32.6 net-647/med-2.4 | ·i-1.9pp (13/67) · p-0.6pp cap16.7 net+178/med+3.2 |
...
| ny_only | ▼i-5.5pp (6/38) · p+18.7pp cap34.0 net-267/med-1.6 | ▲i+8.1pp (6/25) · p+14.0pp cap12.5 net+16/med+1.8 |
...
- forward payoff: right +388 / wrong -210 / net +178 pts; median per fire +3.20 (n=67)
...
| session | backtest | forward |
|---|---|---|
| whole | (°▲i+25.7pp (1/2) · p+26.4pp cap37.0 net+28/med+13.8) | (°▼i-21.3pp (0/3) · p+8.8pp cap6.7 net-33/med-6.1) |
| london | (°▲i+24.0pp (1/2) · p+25.1pp cap37.0 net+28/med+13.8) | — |
| overlap | — | — |
| ny_only | — | (°▼i-15.9pp (0/1) · p-6.0pp cap— net-3/med-3.0) |
| dead | — | — |
...
Store span (1M, close ts): 2026-07-19 22:42:00+00:00 → 2026-08-21 15:54:00+00:00. Volume type: real futures volume (register 40 first-sync sanity; canonical verdict at this instrument's validation evening).
...
| H | label | backtest whole | backtest london | forward whole | forward london |
|---|---|---|---|---|---|
| *context* | | 110 ep; chance 23.8%dir/45.1%either | 27 ep; chance 26.4%dir/51.2%either | 56 ep; chance 21.9%dir/40.4%either | 16 ep; chance 23.9%dir/45.5%either |
| S0-H1 | keep-watching | ▼i-2.6pp (9/49) · p+10.9pp cap89.9 net-83/med+0.7 | (°▼i-21.1pp (0/5) · p+33.6pp cap89.9 net+198/med+39.9) | ·i-1.2pp (11/49) · p+12.8pp cap36.0 net+115/med-2.5 | (°▲i+3.9pp (4/13) · p+22.3pp cap48.2 net+47/med+11.2) |
| S1-H1 | keep-watching | (°▼i-21.0pp (0/3) · p-23.8pp cap— net-72/med-34.2) | (°▼i-21.1pp (0/1) · p-26.4pp cap— net-54/med-53.5) | (°▲i+26.4pp (1/2) · p-21.9pp cap— net-28/med-14.2) | — |
| S0-H2 | promote-candidate | ▼i-7.8pp (31/234) · p+0.6pp cap77.8 net-661/med-5.2 | (°▼i-7.8pp (2/15) · p-13.1pp cap86.6 net+93/med+9.8) | ·i-0.7pp (32/140) · p+3.8pp cap34.2 net-188/med-1.9 | ·i+1.7pp (8/28) · p-6.0pp cap66.5 net-93/med-11.2 |
| S1-H2 | promote-candidate | ▼i-6.8pp (25/176) · p+2.3pp cap77.4 net-760/med-8.3 | (°▼i-5.7pp (2/13) · p-11.0pp cap86.6 net+136/med+14.0) | ▲i+2.1pp (26/101) · p+6.8pp cap33.1 net+58/med-1.0 | (°▲i+6.4pp (6/18) · p-7.2pp cap83.2 net-23/med-12.2) |
| S0-H3 | keep-watching | (°▲i+4.0pp (2/8) · p-11.3pp cap70.3 net-28/med+2.0) | — | (°▲i+6.4pp (3/10) · p-21.9pp cap— net-26/med-8.2) | (°▼i-26.9pp (0/1) · p-23.9pp cap— net+19/med+18.8) |
| S0-H4 | keep-watching | ▼i-3.4pp (6/34) · p+5.6pp cap53.4 net+72/med+10.0 | (°▲i+8.9pp (3/10) · p-16.4pp cap50.2 net-30/med-3.7) | — | — |
| S0-H5 | keep-watching | — | — | — | — |
| S0-H6 | keep-watching | ▼i-8.1pp (2/36) · p+3.9pp cap59.3 [cls 35.0%/13.7%i] net-192/med-10.4 | (°▼i-4.3pp (1/18) · p-7.4pp cap78.7 [cls 35.2%/9.9%i] net-56/med-10.3) | ▲i+25.1pp (28/60) · p-7.8pp cap45.6 [cls 37.8%/21.6%i] net-865/med-10.4 | ▲i+38.2pp (21/34) · p-19.1pp cap53.4 [cls 36.7%/23.6%i] net-879/med-24.9 |
| S0-H7 | keep-watching | ·i-0.7pp (12/59) · p+11.8pp cap97.8 net+761/med+4.2 | ▼i-11.1pp (2/20) · p+23.6pp cap86.9 net+719/med+33.0 | ▲i+9.7pp (8/24) · p-5.2pp cap85.5 net-177/med-4.6 | (°▲i+17.5pp (8/18) · p-7.2pp cap88.2 net-172/med-4.6) |
| S0-H7 (either-dir) | keep-watching | ▼i-5.3pp (20/59) · p+19.3pp cap50.2 | ▼i-10.2pp (6/20) · p+23.8pp cap57.4 | ▲i+6.1pp (12/24) · p+5.4pp cap14.6 | (°▲i+11.8pp (11/18) · p+10.1pp cap11.6) |
| S0-H8 | keep-watching | ▼i-8.4pp (72/234) · p+7.9pp cap35.5 | (°▼i-20.2pp (3/15) · p-31.2pp cap68.2) | ·i+1.1pp (63/140) · p+0.3pp cap23.4 | ▼i-10.0pp (11/28) · p-9.8pp cap29.6 |
| S0-H9 | keep-watching | ▲i+4.0pp (13/52) · p-8.4pp cap55.5 net-426/med-4.1 | (°▼i-21.1pp (0/3) · p-26.4pp cap— net+17/med+22.6) | (°▲i+16.4pp (4/10) · p-21.9pp cap— net-210/med-6.6) | (°▲i+23.1pp (1/2) · p-23.9pp cap— net-158/med-78.9) |
| S1-H9 | keep-watching | (°▼i-21.0pp (0/8) · p+26.2pp cap101.1 net-53/med+13.1) | — | (°▲i+43.1pp (2/3) · p-21.9pp cap— net-127/med-7.7) | (°▲i+73.1pp (1/1) · p-23.9pp cap— net-114/med-114.2) |
| S0-H10 | deprioritize | ▲i+4.9pp (38/147) · p-4.1pp cap49.6 net-391/med+3.2 | ▲i+2.0pp (9/39) · p-16.1pp cap80.6 net-463/med-12.5 | ·i+1.1pp (19/77) · p+2.8pp cap28.9 net+168/med+3.0 | (°▲i+6.4pp (5/15) · p+2.8pp cap42.4 net+73/med+17.1) |
| S0-H11 | keep-watching | ·i-0.7pp (15/74) · p-3.5pp cap68.3 net-452/med-6.0 | (°▼i-21.1pp (0/14) · p-5.0pp cap73.1 net-472/med-58.8) | ▼i-4.8pp (34/181) · p+0.2pp cap45.2 net-416/med-5.5 | ·i+0.9pp (27/97) · p-5.3pp cap53.4 net-220/med-3.0 |
| S0-H12 | keep-watching | — | — | — | — |
| S0-H13 | keep-watching | (°▼i-4.3pp (1/6) · p+59.5pp cap74.2 net+397/med+58.7) | (°▼i-21.1pp (0/2) · p+73.6pp cap116.8 net+181/med+90.7) | (°·i+1.4pp (1/4) · p-21.9pp cap— net-27/med-2.0) | (°▲i+6.4pp (1/3) · p-23.9pp cap— net-22/med+0.9) |
| **union coverage** | | 43.6% (48/110) | 25.9% (7/27) | 80.4% (45/56) | 93.8% (15/16) |
...
| session | backtest | forward |
|---|---|---|
| whole | ▼i-2.6pp (9/49) · p+10.9pp cap89.9 net-83/med+0.7 | ·i-1.2pp (11/49) · p+12.8pp cap36.0 net+115/med-2.5 |
| london | (°▼i-21.1pp (0/5) · p+33.6pp cap89.9 net+198/med+39.9) | (°▲i+3.9pp (4/13) · p+22.3pp cap48.2 net+47/med+11.2) |
| overlap | — | (°▲i+7.8pp (1/3) · p+13.9pp cap51.7 net+44/med+28.7) |
| ny_only | (°▼i-19.1pp (0/10) · p+18.8pp cap83.5 net-289/med-3.9) | (°▼i-4.8pp (1/7) · p-5.2pp cap— net-28/med-7.3) |
...
- forward payoff: right +488 / wrong -372 / net +115 pts; median per fire -2.50 (n=49)
...
| session | backtest | forward |
|---|---|---|
| whole | (°▼i-21.0pp (0/3) · p-23.8pp cap— net-72/med-34.2) | (°▲i+26.4pp (1/2) · p-21.9pp cap— net-28/med-14.2) |
| london | (°▼i-21.1pp (0/1) · p-26.4pp cap— net-54/med-53.5) | — |
| overlap | — | — |
| ny_only | — | (°▼i-19.1pp (0/1) · p-5.2pp cap— net-7/med-7.4) |
| dead | — | — |
...
| session | backtest | forward |
|---|---|---|
| whole | ▼i-7.8pp (31/234) · p+0.6pp cap77.8 net-661/med-5.2 | ·i-0.7pp (32/140) · p+3.8pp cap34.2 net-188/med-1.9 |
| london | (°▼i-7.8pp (2/15) · p-13.1pp cap86.6 net+93/med+9.8) | ·i+1.7pp (8/28) · p-6.0pp cap66.5 net-93/med-11.2 |
| overlap | (°▼i-13.3pp (0/11) · p-14.8pp cap122.7 net-195/med-38.7) | (°·i-0.5pp (2/8) · p-19.4pp cap— net-144/med-26.1) |
| ny_only | ▼i-9.3pp (6/61) · p+11.8pp cap77.4 net-1116/med-16.7 | ▲i+9.5pp (8/28) · p-5.2pp cap— net+9/med-1.9 |
...
| session | backtest | forward |
|---|---|---|
| whole | ▼i-6.8pp (25/176) · p+2.3pp cap77.4 net-760/med-8.3 | ▲i+2.1pp (26/101) · p+6.8pp cap33.1 net+58/med-1.0 |
| london | (°▼i-5.7pp (2/13) · p-11.0pp cap86.6 net+136/med+14.0) | (°▲i+6.4pp (6/18) · p-7.2pp cap83.2 net-23/med-12.2) |
| overlap | (°▼i-13.3pp (0/7) · p-9.6pp cap122.7 net-89/med-38.1) | (°▲i+7.8pp (2/6) · p-19.4pp cap— net-74/med-13.0) |
| ny_only | ▼i-10.2pp (4/45) · p+17.7pp cap77.0 net-1094/med-25.7 | (°▲i+12.5pp (6/19) · p-5.2pp cap— net+39/med+1.0) |
...
| session | backtest | forward |
|---|---|---|
| whole | (°▲i+4.0pp (2/8) · p-11.3pp cap70.3 net-28/med+2.0) | (°▲i+6.4pp (3/10) · p-21.9pp cap— net-26/med-8.2) |
| london | — | (°▼i-26.9pp (0/1) · p-23.9pp cap— net+19/med+18.8) |
| overlap | — | — |
| ny_only | (°▲i+20.9pp (2/5) · p+8.8pp cap70.3 net+132/med+41.2) | (°·i+0.9pp (1/5) · p-5.2pp cap— net-10/med-14.9) |
| dead | — | — |
...
| overlap | (°▼i-13.3pp (0/6) · p+9.4pp cap59.3 net-4/med-8.4) | — |
...
| session | backtest | forward |
|---|---|---|
| whole | ▼i-8.1pp (2/36) · p+3.9pp cap59.3 [cls 35.0%/13.7%i] net-192/med-10.4 | ▲i+25.1pp (28/60) · p-7.8pp cap45.6 [cls 37.8%/21.6%i] net-865/med-10.4 |
| london | (°▼i-4.3pp (1/18) · p-7.4pp cap78.7 [cls 35.2%/9.9%i] net-56/med-10.3) | ▲i+38.2pp (21/34) · p-19.1pp cap53.4 [cls 36.7%/23.6%i] net-879/med-24.9 |
| overlap | (°▼i-13.2pp (0/1) · p+71.3pp cap122.7 [cls 28.7%/13.2%i] net+108/med+108.3) | (°▲i+18.7pp (3/6) · p-3.2pp cap47.6 [cls 19.9%/31.3%i] net-12/med-10.5) |
| ny_only | — | — |
...
| session | backtest | forward |
|---|---|---|
| whole | ·i-0.7pp (12/59) · p+11.8pp cap97.8 net+761/med+4.2 | ▲i+9.7pp (8/24) · p-5.2pp cap85.5 net-177/med-4.6 |
| london | ▼i-11.1pp (2/20) · p+23.6pp cap86.9 net+719/med+33.0 | (°▲i+17.5pp (8/18) · p-7.2pp cap88.2 net-172/med-4.6) |
| overlap | (°▼i-6.6pp (1/15) · p+22.8pp cap91.3 net+56/med-29.0) | (°▼i-25.5pp (0/2) · p-19.4pp cap— net+11/med+5.5) |
| ny_only | (°▼i-2.4pp (1/6) · p+5.5pp cap101.1 net+59/med+7.7) | (°▼i-19.1pp (0/3) · p-5.2pp cap— net-44/med-28.5) |
...
- forward payoff: right +275 / wrong -452 / net -177 pts; median per fire -4.60 (n=24)
...
| session | backtest | forward |
|---|---|---|
| whole | ▼i-5.3pp (20/59) · p+19.3pp cap50.2 | ▲i+6.1pp (12/24) · p+5.4pp cap14.6 |
| london | ▼i-10.2pp (6/20) · p+23.8pp cap57.4 | (°▲i+11.8pp (11/18) · p+10.1pp cap11.6) |
| overlap | (°▼i-19.9pp (1/15) · p+33.1pp cap65.0) | (°▼i-51.0pp (0/2) · p-38.9pp cap—) |
| ny_only | (°·i-0.7pp (2/6) · p+11.3pp cap52.5) | (°▼i-4.0pp (1/3) · p-10.4pp cap—) |
...
| session | backtest | forward |
|---|---|---|
| whole | ▼i-8.4pp (72/234) · p+7.9pp cap35.5 | ·i+1.1pp (63/140) · p+0.3pp cap23.4 |
| london | (°▼i-20.2pp (3/15) · p-31.2pp cap68.2) | ▼i-10.0pp (11/28) · p-9.8pp cap29.6 |
| overlap | (°▼i-17.5pp (1/11) · p+16.7pp cap37.2) | (°▲i+11.5pp (5/8) · p-1.4pp cap9.7) |
| ny_only | ▼i-7.8pp (16/61) · p+32.1pp cap32.0 | ▲i+5.6pp (12/28) · p-10.4pp cap— |
...
| session | backtest | forward |
|---|---|---|
| whole | ▲i+4.0pp (13/52) · p-8.4pp cap55.5 net-426/med-4.1 | (°▲i+16.4pp (4/10) · p-21.9pp cap— net-210/med-6.6) |
| london | (°▼i-21.1pp (0/3) · p-26.4pp cap— net+17/med+22.6) | (°▲i+23.1pp (1/2) · p-23.9pp cap— net-158/med-78.9) |
| overlap | (°▼i-13.3pp (0/2) · p-23.9pp cap— net+112/med+55.8) | (°▼i-25.5pp (0/1) · p-19.4pp cap— net-18/med-17.7) |
| ny_only | ▲i+12.7pp (7/22) · p-6.7pp cap32.0 net-517/med-19.3 | (°▲i+20.9pp (2/5) · p-5.2pp cap— net-24/med-2.6) |
...
| session | backtest | forward |
|---|---|---|
| whole | (°▼i-21.0pp (0/8) · p+26.2pp cap101.1 net-53/med+13.1) | (°▲i+43.1pp (2/3) · p-21.9pp cap— net-127/med-7.7) |
| london | — | (°▲i+73.1pp (1/1) · p-23.9pp cap— net-114/med-114.2) |
| overlap | (°▼i-13.3pp (0/1) · p-23.9pp cap— net+56/med+55.8) | — |
| ny_only | (°▼i-19.1pp (0/2) · p-11.2pp cap— net-320/med-160.1) | (°▼i-19.1pp (0/1) · p-5.2pp cap— net-8/med-7.7) |
...
| session | backtest | forward |
|---|---|---|
| whole | ▲i+4.9pp (38/147) · p-4.1pp cap49.6 net-391/med+3.2 | ·i+1.1pp (19/77) · p+2.8pp cap28.9 net+168/med+3.0 |
| london | ▲i+2.0pp (9/39) · p-16.1pp cap80.6 net-463/med-12.5 | (°▲i+6.4pp (5/15) · p+2.8pp cap42.4 net+73/med+17.1) |
| overlap | (°▼i-13.3pp (0/9) · p-1.7pp cap59.5 net-114/med-21.0) | (°▲i+12.0pp (3/8) · p-6.9pp cap47.7 net+50/med+4.8) |
| ny_only | ▼i-4.4pp (5/34) · p+3.5pp cap46.4 net+237/med+4.4 | (°▼i-13.2pp (1/17) · p+18.3pp cap21.4 net+83/med+7.2) |
...
- backtest worst false alarm: 2026-07-26 23:29 -102.8pts adverse
- forward payoff: right +687 / wrong -519 / net +168 pts; median per fire +3.00 (n=76)
...
| session | backtest | forward |
|---|---|---|
| whole | ·i-0.7pp (15/74) · p-3.5pp cap68.3 net-452/med-6.0 | ▼i-4.8pp (34/181) · p+0.2pp cap45.2 net-416/med-5.5 |
| london | (°▼i-21.1pp (0/14) · p-5.0pp cap73.1 net-472/med-58.8) | ·i+0.9pp (27/97) · p-5.3pp cap53.4 net-220/med-3.0 |
| overlap | (°·i-0.8pp (2/16) · p-17.7pp cap68.3 net-166/med-13.2) | (°▼i-25.5pp (0/9) · p-19.4pp cap— net+10/med-1.1) |
| ny_only | (°▼i-19.1pp (0/4) · p-11.2pp cap— net-18/med-18.5) | (°▲i+14.2pp (2/6) · p-5.2pp cap— net-54/med-24.1) |
...
| session | backtest | forward |
|---|---|---|
| whole | (°▼i-4.3pp (1/6) · p+59.5pp cap74.2 net+397/med+58.7) | (°·i+1.4pp (1/4) · p-21.9pp cap— net-27/med-2.0) |
| london | (°▼i-21.1pp (0/2) · p+73.6pp cap116.8 net+181/med+90.7) | (°▲i+6.4pp (1/3) · p-23.9pp cap— net-22/med+0.9) |
| overlap | — | — |
| ny_only | — | (°▼i-19.1pp (0/1) · p-5.2pp cap— net-5/med-5.0) |
...
Store span (1M, close ts): 2026-07-19 22:02:00+00:00 → 2026-08-21 15:55:00+00:00. Volume type: real futures volume (register 40 first-sync sanity; canonical verdict at this instrument's validation evening).
...
| H | label | backtest whole | backtest london | forward whole | forward london |
|---|---|---|---|---|---|
| *context* | | 114 ep; chance 22.0%dir/41.6%either | 40 ep; chance 30.9%dir/56.0%either | 55 ep; chance 22.1%dir/42.3%either | 17 ep; chance 32.5%dir/61.9%either |
| S0-H1 | keep-watching | ·i-1.1pp (7/34) · p+19.2pp cap182.2 net+122/med-15.7 | (°▲i+11.7pp (3/8) · p-18.4pp cap153.6 net-257/med-46.2) | ▲i+15.2pp (13/34) · p+16.1pp cap74.9 net+267/med+14.9 | ▲i+11.3pp (8/20) · p+2.5pp cap96.9 net-27/med+7.8 |
| S1-H1 | keep-watching | (°▲i+11.6pp (1/3) · p+44.7pp cap279.0 net+465/med+128.4) | — | (°▼i-23.0pp (0/1) · p+77.9pp cap74.3 net+74/med+74.3) | (°▼i-28.7pp (0/1) · p+67.5pp cap74.3 net+74/med+74.3) |
| S0-H2 | promote-candidate | ▼i-3.3pp (59/320) · p-2.3pp cap157.6 net-3528/med-1.4 | ·i+1.3pp (16/59) · p-5.5pp cap106.7 net-313/med-30.0 | ▼i-2.4pp (45/218) · p+8.6pp cap75.1 net-61/med-1.9 | ▼i-2.6pp (23/88) · p+3.9pp cap88.0 net+291/med+2.6 |
| S1-H2 | promote-candidate | ▼i-2.8pp (42/222) · p-1.7pp cap144.4 net-1379/med-4.2 | ▲i+4.4pp (13/43) · p-3.0pp cap101.9 net-382/med-31.5 | ·i+0.6pp (37/157) · p+8.5pp cap74.4 net-6/med+3.5 | ▲i+3.0pp (19/60) · p-0.8pp cap85.6 net-74/med+2.6 |
| S0-H3 | keep-watching | (°▼i-21.7pp (0/1) · p+78.0pp cap105.8 net+106/med+105.8) | (°▼i-25.8pp (0/1) · p+69.1pp cap105.8 net+106/med+105.8) | — | — |
| S0-H4 | keep-watching | — | — | (°▼i-23.0pp (0/10) · p+37.9pp cap38.4 net-18/med-7.4) | (°▼i-28.7pp (0/5) · p+7.5pp cap31.1 net+26/med+9.5) |
| S0-H5 | keep-watching | — | — | — | — |
| S0-H6 | keep-watching | ▲i+4.5pp (5/29) · p-8.2pp cap260.8 [cls 39.2%/12.7%i] net-232/med-11.8 | (°▲i+59.9pp (4/5) · p-38.6pp cap— [cls 38.6%/20.1%i] net-719/med-105.3) | ▼i-5.7pp (5/44) · p+2.9pp cap97.4 [cls 35.7%/17.1%i] net+403/med-1.9 | (°▲i+4.1pp (4/13) · p+3.7pp cap90.7 [cls 34.8%/26.7%i] net+354/med+16.3) |
| S0-H7 | keep-watching | ▼i-5.7pp (8/50) · p+0.0pp cap169.0 net+77/med-7.8 | (°·i-0.8pp (4/16) · p-5.9pp cap123.6 net-167/med-6.6) | ▲i+3.3pp (10/38) · p+4.2pp cap101.6 net+320/med+10.8 | (°▲i+17.5pp (6/13) · p-9.4pp cap105.7 net+18/med-19.6) |
| S0-H7 (either-dir) | keep-watching | ▼i-10.5pp (15/50) · p+4.4pp cap46.5 | (°▲i+2.1pp (8/16) · p+0.2pp cap23.3) | ·i-0.9pp (16/38) · p+13.0pp cap47.3 | (°▲i+4.4pp (8/13) · p+7.3pp cap44.5) |
| S0-H8 | keep-watching | ▼i-3.9pp (117/320) · p+1.8pp cap65.1 | ▼i-7.2pp (24/59) · p+5.0pp cap53.7 | ▲i+5.6pp (106/218) · p+9.1pp cap56.8 | ▲i+5.4pp (55/88) · p-1.7pp cap68.3 |
| S0-H9 | keep-watching | ▲i+2.2pp (21/88) · p+0.7pp cap129.2 net+593/med-4.3 | (°▼i-25.8pp (0/9) · p+2.4pp cap76.3 net+410/med+11.6) | ▼i-7.1pp (11/69) · p-7.6pp cap62.5 net-613/med-9.9 | (°▲i+21.3pp (2/4) · p+17.5pp cap57.7 net-462/med-132.2) |
| S1-H9 | keep-watching | ▼i-13.7pp (2/25) · p+6.0pp cap265.9 net-373/med+10.8 | (°▼i-25.8pp (0/5) · p-30.9pp cap— net-57/med+2.3) | (°▲i+19.9pp (3/7) · p-7.8pp cap52.5 net-557/med-25.7) | (°▲i+71.3pp (2/2) · p-32.5pp cap— net-493/med-246.5) |
| S0-H10 | deprioritize | ·i-0.6pp (37/175) · p-6.0pp cap92.8 net+2743/med+15.3 | (°▼i-12.5pp (2/15) · p-17.6pp cap46.2 net-356/med-1.7) | ▼i-16.0pp (10/143) · p-3.2pp cap49.8 net-1410/med-8.8 | ▼i-15.7pp (3/23) · p+11.0pp cap47.8 net+79/med-0.6 |
| S0-H11 | keep-watching | ▼i-3.4pp (48/263) · p+2.3pp cap136.1 net+863/med+0.9 | ·i-1.6pp (22/91) · p-2.3pp cap113.7 net+264/med-3.9 | ▼i-2.9pp (34/169) · p+1.6pp cap76.8 net+1035/med+2.4 | ▲i+10.0pp (12/31) · p-0.2pp cap175.6 net+564/med-2.6 |
| S0-H12 | keep-watching | — | — | — | — |
| S0-H13 | keep-watching | (°▼i-21.7pp (0/1) · p+78.0pp cap95.7 net+93/med+93.0) | (°▼i-25.8pp (0/1) · p+69.1pp cap95.7 net+93/med+93.0) | — | — |
| **union coverage** | | 42.1% (48/114) | 37.5% (15/40) | 83.6% (46/55) | 88.2% (15/17) |
...
| session | backtest | forward |
|---|---|---|
| whole | ·i-1.1pp (7/34) · p+19.2pp cap182.2 net+122/med-15.7 | ▲i+15.2pp (13/34) · p+16.1pp cap74.9 net+267/med+14.9 |
| london | (°▲i+11.7pp (3/8) · p-18.4pp cap153.6 net-257/med-46.2) | ▲i+11.3pp (8/20) · p+2.5pp cap96.9 net-27/med+7.8 |
| overlap | — | — |
| ny_only | (°▼i-20.0pp (0/11) · p+50.7pp cap246.0 net-215/med-87.5) | (°▲i+80.9pp (2/2) · p-6.3pp cap— net+13/med+6.3) |
| dead | (°▲i+31.2pp (4/8) · p+1.0pp cap406.7 net-181/med-23.6) | (°▲i+13.4pp (3/8) · p+50.1pp cap68.4 net+263/med+44.3) |
...
- forward payoff: right +1122 / wrong -855 / net +267 pts; median per fire +14.95 (n=34)
...
| session | backtest | forward |
|---|---|---|
| whole | (°▲i+11.6pp (1/3) · p+44.7pp cap279.0 net+465/med+128.4) | (°▼i-23.0pp (0/1) · p+77.9pp cap74.3 net+74/med+74.3) |
| london | — | (°▼i-28.7pp (0/1) · p+67.5pp cap74.3 net+74/med+74.3) |
| overlap | — | — |
| ny_only | — | — |
...
| session | backtest | forward |
|---|---|---|
| whole | ▼i-3.3pp (59/320) · p-2.3pp cap157.6 net-3528/med-1.4 | ▼i-2.4pp (45/218) · p+8.6pp cap75.1 net-61/med-1.9 |
| london | ·i+1.3pp (16/59) · p-5.5pp cap106.7 net-313/med-30.0 | ▼i-2.6pp (23/88) · p+3.9pp cap88.0 net+291/med+2.6 |
| overlap | (°▼i-4.8pp (1/32) · p-12.5pp cap193.4 net-742/med-38.1) | (°▼i-2.9pp (0/12) · p-25.9pp cap153.4 net-208/med-3.8) |
| ny_only | ▼i-10.1pp (7/71) · p+2.6pp cap234.9 net-3199/med-7.4 | (°▲i+18.4pp (6/16) · p-0.1pp cap85.5 net+15/med+2.8) |
| dead | ·i+0.0pp (9/48) · p+5.2pp cap284.2 net+874/med+2.4 | (°▲i+9.2pp (5/15) · p+27.6pp cap71.3 net+44/med+4.5) |
...
| session | backtest | forward |
|---|---|---|
| whole | ▼i-2.8pp (42/222) · p-1.7pp cap144.4 net-1379/med-4.2 | ·i+0.6pp (37/157) · p+8.5pp cap74.4 net-6/med+3.5 |
| london | ▲i+4.4pp (13/43) · p-3.0pp cap101.9 net-382/med-31.5 | ▲i+3.0pp (19/60) · p-0.8pp cap85.6 net-74/med+2.6 |
| overlap | (°▼i-7.9pp (0/20) · p-2.5pp cap185.1 net+164/med+49.0) | (°▼i-2.9pp (0/10) · p-24.2pp cap153.4 net-118/med-3.8) |
| ny_only | ▼i-11.7pp (4/48) · p-0.4pp cap194.2 net-1585/med-19.9 | (°▲i+26.4pp (5/11) · p+2.8pp cap85.5 net+70/med+14.5) |
| dead | ▲i+2.4pp (7/33) · p+0.6pp cap206.8 net+152/med-7.9 | (°▲i+5.9pp (3/10) · p+17.6pp cap80.9 net-9/med+3.1) |
...
| session | backtest | forward |
|---|---|---|
| whole | — | (°▼i-23.0pp (0/10) · p+37.9pp cap38.4 net-18/med-7.4) |
| london | — | (°▼i-28.7pp (0/5) · p+7.5pp cap31.1 net+26/med+9.5) |
| overlap | — | — |
| ny_only | — | — |
| dead | — | — |
...
| session | backtest | forward |
|---|---|---|
| whole | ▲i+4.5pp (5/29) · p-8.2pp cap260.8 [cls 39.2%/12.7%i] net-232/med-11.8 | ▼i-5.7pp (5/44) · p+2.9pp cap97.4 [cls 35.7%/17.1%i] net+403/med-1.9 |
| london | (°▲i+59.9pp (4/5) · p-38.6pp cap— [cls 38.6%/20.1%i] net-719/med-105.3) | (°▲i+4.1pp (4/13) · p+3.7pp cap90.7 [cls 34.8%/26.7%i] net+354/med+16.3) |
...
| ny_only | — | (°▼i-11.5pp (0/1) · p+0.0pp cap— [cls 0.0%/11.5%i] net-31/med-30.7) |
| dead | (°▼i-13.5pp (0/3) · p-23.8pp cap— [cls 23.8%/13.5%i] net+42/med+18.9) | (°▼i-25.0pp (0/1) · p-20.8pp cap— [cls 20.8%/25.0%i] net+16/med+15.9) |
...
| session | backtest | forward |
|---|---|---|
| whole | ▼i-5.7pp (8/50) · p+0.0pp cap169.0 net+77/med-7.8 | ▲i+3.3pp (10/38) · p+4.2pp cap101.6 net+320/med+10.8 |
| london | (°·i-0.8pp (4/16) · p-5.9pp cap123.6 net-167/med-6.6) | (°▲i+17.5pp (6/13) · p-9.4pp cap105.7 net+18/med-19.6) |
| overlap | (°▲i+4.6pp (1/8) · p+25.0pp cap183.1 net+464/med+8.3) | (°▼i-2.9pp (0/8) · p+15.8pp cap115.7 net+99/med+26.9) |
| ny_only | (°▲i+5.0pp (2/8) · p-12.9pp cap— net-76/med-18.5) | (°▼i-19.1pp (0/5) · p-6.3pp cap— net+161/med+30.8) |
| dead | (°·i+1.2pp (1/5) · p-11.5pp cap— net+53/med+23.0) | (°▲i+9.2pp (1/3) · p-12.4pp cap— net+71/med+21.8) |
...
- forward payoff: right +1273 / wrong -953 / net +320 pts; median per fire +10.80 (n=38)
...
| session | backtest | forward |
|---|---|---|
| whole | ▼i-10.5pp (15/50) · p+4.4pp cap46.5 | ·i-0.9pp (16/38) · p+13.0pp cap47.3 |
| london | (°▲i+2.1pp (8/16) · p+0.2pp cap23.3) | (°▲i+4.4pp (8/13) · p+7.3pp cap44.5) |
| overlap | (°▼i-3.3pp (1/8) · p+30.0pp cap118.7) | (°▼i-5.8pp (0/8) · p-2.0pp cap113.3) |
| ny_only | (°·i+0.3pp (3/8) · p-12.8pp cap18.8) | (°▼i-12.7pp (1/5) · p-12.6pp cap—) |
| dead | (°▼i-15.0pp (1/5) · p-22.2pp cap—) | (°▼i-8.7pp (1/3) · p+9.7pp cap21.8) |
...
| session | backtest | forward |
|---|---|---|
| whole | ▼i-3.9pp (117/320) · p+1.8pp cap65.1 | ▲i+5.6pp (106/218) · p+9.1pp cap56.8 |
| london | ▼i-7.2pp (24/59) · p+5.0pp cap53.7 | ▲i+5.4pp (55/88) · p-1.7pp cap68.3 |
| overlap | (°▼i-9.6pp (2/32) · p-4.4pp cap69.4) | (°▼i-5.8pp (0/12) · p-47.8pp cap72.5) |
| ny_only | ▼i-13.3pp (17/71) · p+18.4pp cap52.0 | (°▲i+36.1pp (11/16) · p-6.4pp cap85.5) |
| dead | ▼i-3.8pp (15/48) · p+2.8pp cap133.9 | (°▲i+18.0pp (9/15) · p+36.4pp cap65.3) |
...
| session | backtest | forward |
|---|---|---|
| whole | ▲i+2.2pp (21/88) · p+0.7pp cap129.2 net+593/med-4.3 | ▼i-7.1pp (11/69) · p-7.6pp cap62.5 net-613/med-9.9 |
| london | (°▼i-25.8pp (0/9) · p+2.4pp cap76.3 net+410/med+11.6) | (°▲i+21.3pp (2/4) · p+17.5pp cap57.7 net-462/med-132.2) |
| overlap | (°▼i-7.9pp (0/10) · p+12.5pp cap306.3 net+540/med+51.3) | (°▼i-2.9pp (0/7) · p-19.9pp cap73.7 net-43/med-10.2) |
| ny_only | ▲i+28.0pp (12/25) · p-4.9pp cap125.7 net-148/med-7.0 | (°·i-1.7pp (4/23) · p+2.4pp cap61.4 net-203/med-9.7) |
| dead | (°▲i+4.7pp (4/17) · p+17.9pp cap265.9 net+98/med-5.5) | (°▼i-24.1pp (0/5) · p-12.4pp cap— net+23/med+6.0) |
...
| session | backtest | forward |
|---|---|---|
| whole | ▼i-13.7pp (2/25) · p+6.0pp cap265.9 net-373/med+10.8 | (°▲i+19.9pp (3/7) · p-7.8pp cap52.5 net-557/med-25.7) |
| london | (°▼i-25.8pp (0/5) · p-30.9pp cap— net-57/med+2.3) | (°▲i+71.3pp (2/2) · p-32.5pp cap— net-493/med-246.5) |
| overlap | (°▼i-7.9pp (0/1) · p+62.5pp cap306.3 net+150/med+150.3) | — |
| ny_only | (°▼i-20.0pp (0/3) · p-12.9pp cap— net-373/med+63.9) | (°▲i+30.9pp (1/2) · p-6.3pp cap— net-94/med-47.2) |
...
| session | backtest | forward |
|---|---|---|
| whole | ·i-0.6pp (37/175) · p-6.0pp cap92.8 net+2743/med+15.3 | ▼i-16.0pp (10/143) · p-3.2pp cap49.8 net-1410/med-8.8 |
| london | (°▼i-12.5pp (2/15) · p-17.6pp cap46.2 net-356/med-1.7) | ▼i-15.7pp (3/23) · p+11.0pp cap47.8 net+79/med-0.6 |
| overlap | (°▼i-7.9pp (0/18) · p-37.5pp cap— net+764/med+45.5) | (°▼i-2.9pp (0/20) · p-19.2pp cap119.2 net-674/med-50.1) |
| ny_only | ▲i+2.9pp (11/48) · p-6.7pp cap88.9 net+398/med+12.5 | (°▼i-14.6pp (1/22) · p+7.3pp cap32.3 net-166/med-15.8) |
| dead | (°▼i-6.3pp (2/16) · p+1.0pp cap254.7 net+551/med+8.9) | (°▼i-7.4pp (2/12) · p-12.4pp cap— net-141/med-8.9) |
...
- forward payoff: right +1185 / wrong -2595 / net -1410 pts; median per fire -8.80 (n=143)
...
| session | backtest | forward |
|---|---|---|
| whole | ▼i-3.4pp (48/263) · p+2.3pp cap136.1 net+863/med+0.9 | ▼i-2.9pp (34/169) · p+1.6pp cap76.8 net+1035/med+2.4 |
| london | ·i-1.6pp (22/91) · p-2.3pp cap113.7 net+264/med-3.9 | ▲i+10.0pp (12/31) · p-0.2pp cap175.6 net+564/med-2.6 |
| overlap | (°▼i-7.9pp (0/20) · p+2.5pp cap232.1 net-137/med-23.4) | (°▼i-2.9pp (0/22) · p-2.4pp cap82.0 net+80/med+39.9) |
| ny_only | ▼i-13.1pp (2/29) · p+14.7pp cap229.4 net+826/med+77.1 | (°▼i-6.2pp (8/62) · p-3.1pp cap44.9 net-49/med+0.3) |
| dead | ·i-1.6pp (10/58) · p+10.9pp cap98.2 net+874/med-3.1 | (°▼i-2.7pp (3/14) · p+16.2pp cap79.7 net-117/med-10.8) |
...
Store span (1M, close ts): 2026-07-19 22:02:00+00:00 → 2026-08-21 15:56:00+00:00. Volume type: real futures volume (register 40 first-sync sanity; canonical verdict at this instrument's validation evening).
...
| H | label | backtest whole | backtest london | forward whole | forward london |
|---|---|---|---|---|---|
| *context* | | 110 ep; chance 23.9%dir/44.6%either | 36 ep; chance 36.3%dir/65.8%either | 48 ep; chance 23.6%dir/44.8%either | 15 ep; chance 38.1%dir/71.7%either |
| S0-H1 | keep-watching | ▲i+3.3pp (12/49) · p+8.8pp cap158.0 net-83/med-8.0 | (°▲i+16.7pp (7/17) · p-6.9pp cap103.5 net-113/med-17.5) | ·i-0.8pp (13/65) · p+10.2pp cap54.8 net-840/med+0.5 | ▲i+7.7pp (8/28) · p-6.0pp cap80.0 net-966/med-20.0 |
| S1-H1 | keep-watching | (°▼i-21.2pp (0/2) · p-23.9pp cap— net-18/med-9.2) | (°▼i-24.5pp (0/1) · p-36.3pp cap— net-50/med-50.0) | (°▲i+16.7pp (3/8) · p-11.1pp cap68.5 net-619/med-62.2) | (°▲i+29.1pp (3/6) · p-38.1pp cap— net-612/med-81.8) |
| S0-H2 | promote-candidate | ▼i-6.3pp (42/281) · p+1.4pp cap138.9 net-2432/med-4.0 | ·i-0.3pp (15/62) · p-2.4pp cap119.0 net-337/med-20.0 | ▼i-2.9pp (40/224) · p+4.1pp cap67.8 net+531/med-0.8 | ▼i-5.2pp (14/89) · p+1.2pp cap82.0 net+724/med+6.0 |
| S1-H2 | promote-candidate | ▼i-4.8pp (36/220) · p+2.5pp cap139.2 net-505/med-2.8 | ·i-0.5pp (12/50) · p-0.3pp cap126.8 net-218/med-18.0 | ▲i+2.6pp (39/167) · p-0.2pp cap63.5 net+38/med-1.0 | ▲i+5.0pp (14/54) · p-8.5pp cap85.8 net+64/med-5.8 |
| S0-H3 | keep-watching | (°▼i-21.2pp (0/4) · p+1.1pp cap81.0 net+59/med+13.2) | (°▼i-24.5pp (0/2) · p-36.3pp cap— net-22/med-11.0) | (°▼i-20.8pp (0/1) · p-23.6pp cap— net-13/med-13.0) | — |
| S0-H4 | keep-watching | (°▲i+17.3pp (5/13) · p+14.6pp cap83.0 net+194/med+15.0) | (°▼i-24.5pp (0/7) · p+35.1pp cap83.0 net+392/med+71.0) | — | — |
| S0-H5 | keep-watching | (°▼i-21.2pp (0/1) · p-23.9pp cap— net-135/med-135.0) | (°▼i-24.5pp (0/1) · p-36.3pp cap— net-135/med-135.0) | (°▼i-20.8pp (0/1) · p+76.4pp cap215.0 net+24/med+24.0) | (°▼i-20.9pp (0/1) · p+61.9pp cap215.0 net+24/med+24.0) |
| S0-H6 | keep-watching | ▼i-6.1pp (5/52) · p-21.3pp cap175.0 [cls 40.5%/15.7%i] net-1151/med-25.2 | ·i+0.8pp (5/24) · p-28.4pp cap164.5 [cls 40.9%/20.0%i] net-664/med-30.0 | ▲i+5.4pp (10/47) · p-1.0pp cap88.5 [cls 41.4%/15.9%i] net-597/med-14.5 | ·i-1.5pp (4/21) · p+24.5pp cap96.8 [cls 42.2%/20.5%i] net+380/med+26.5 |
| S0-H7 | keep-watching | ▲i+5.6pp (11/41) · p-1.9pp cap111.0 net+205/med-9.0 | (°▲i+6.7pp (5/16) · p-5.1pp cap111.0 net-161/med-7.0) | ·i-1.4pp (7/36) · p+9.7pp cap70.0 net+386/med+4.8 | (°▼i-8.4pp (1/8) · p-0.6pp cap71.5 net-141/med-32.0) |
| S0-H7 (either-dir) | keep-watching | ·i-0.3pp (16/41) · p-3.1pp cap66.5 | (°▼i-14.0pp (5/16) · p+3.0pp cap60.5) | ▼i-7.3pp (11/36) · p+10.8pp cap36.0 | (°▼i-29.3pp (1/8) · p+28.3pp cap26.5) |
| S0-H8 | keep-watching | ▼i-13.3pp (73/281) · p+7.4pp cap76.5 | ▼i-6.5pp (24/62) · p+6.8pp cap60.5 | ▼i-4.0pp (76/224) · p+4.3pp cap42.5 | ▼i-5.8pp (32/89) · p-6.5pp cap58.8 |
| S0-H9 | keep-watching | ▼i-13.7pp (3/40) · p-1.4pp cap66.0 net-353/med-14.7 | (°▼i-24.5pp (0/3) · p-3.0pp cap52.0 net-198/med-61.5) | ▼i-10.8pp (2/20) · p-13.6pp cap169.5 net-558/med-31.0 | (°·i+1.3pp (2/9) · p-15.9pp cap169.5 net-363/med-76.0) |
| S1-H9 | keep-watching | (°▼i-21.2pp (0/9) · p-1.7pp cap273.0 net+460/med+1.5) | (°▼i-24.5pp (0/1) · p-36.3pp cap— net-38/med-38.0) | (°▼i-2.6pp (2/11) · p-5.4pp cap169.5 net-375/med-31.0) | (°▲i+4.1pp (2/8) · p-13.1pp cap169.5 net-305/med-84.8) |
| S0-H10 | deprioritize | ·i-1.7pp (30/154) · p+1.4pp cap71.0 net+1774/med+11.0 | ▼i-19.5pp (2/40) · p+3.7pp cap116.0 net+1480/med+27.5 | ▼i-4.8pp (25/156) · p-3.7pp cap56.5 net+230/med-0.5 | ▲i+3.5pp (10/41) · p-4.0pp cap80.5 net+196/med-11.0 |
| S0-H11 | keep-watching | ·i-0.4pp (86/413) · p+3.5pp cap98.0 net+1254/med+3.0 | ▼i-5.5pp (31/163) · p+1.1pp cap91.0 net-404/med+5.0 | ·i+0.4pp (65/306) · p+3.2pp cap65.2 net-370/med-5.0 | ▼i-2.3pp (24/129) · p-0.9pp cap75.0 net+175/med+0.0 |
| S0-H12 | keep-watching | — | — | — | — |
| S0-H13 | keep-watching | (°▲i+78.8pp (1/1) · p-23.9pp cap— net-206/med-206.0) | (°▲i+75.5pp (1/1) · p-36.3pp cap— net-206/med-206.0) | — | — |
| **union coverage** | | 40.0% (44/110) | 33.3% (12/36) | 91.7% (44/48) | 93.3% (14/15) |
...
| session | backtest | forward |
|---|---|---|
| whole | ▲i+3.3pp (12/49) · p+8.8pp cap158.0 net-83/med-8.0 | ·i-0.8pp (13/65) · p+10.2pp cap54.8 net-840/med+0.5 |
| london | (°▲i+16.7pp (7/17) · p-6.9pp cap103.5 net-113/med-17.5) | ▲i+7.7pp (8/28) · p-6.0pp cap80.0 net-966/med-20.0 |
| overlap | — | (°▼i-9.9pp (0/2) · p+19.5pp cap186.5 net+119/med+59.5) |
| ny_only | (°▼i-3.8pp (2/13) · p+40.2pp cap253.5 net-62/med-15.5) | (°▲i+30.5pp (1/2) · p-9.9pp cap— net+61/med+30.5) |
| dead | (°▲i+28.3pp (3/7) · p-7.1pp cap— net-157/med-8.0) | (°▲i+11.5pp (2/7) · p+11.0pp cap44.0 net+46/med+7.0) |
...
- forward payoff: right +1200 / wrong -2040 / net -840 pts; median per fire +0.50 (n=65)
...
| session | backtest | forward |
|---|---|---|
| whole | (°▼i-21.2pp (0/2) · p-23.9pp cap— net-18/med-9.2) | (°▲i+16.7pp (3/8) · p-11.1pp cap68.5 net-619/med-62.2) |
...
| session | backtest | forward |
|---|---|---|
| whole | ▼i-6.3pp (42/281) · p+1.4pp cap138.9 net-2432/med-4.0 | ▼i-2.9pp (40/224) · p+4.1pp cap67.8 net+531/med-0.8 |
| london | ·i-0.3pp (15/62) · p-2.4pp cap119.0 net-337/med-20.0 | ▼i-5.2pp (14/89) · p+1.2pp cap82.0 net+724/med+6.0 |
| overlap | (°▼i-11.4pp (0/22) · p+3.7pp cap177.5 net-1080/med-77.8) | (°▲i+6.8pp (2/12) · p-5.5pp cap185.5 net-58/med-44.5) |
| ny_only | ▼i-14.2pp (3/60) · p+21.4pp cap239.5 net-1257/med-11.1 | ▲i+11.3pp (8/26) · p-6.1pp cap96.5 net-265/med-5.0 |
| dead | ·i+0.0pp (6/41) · p+2.7pp cap100.8 net-18/med-2.6 | (°▲i+10.9pp (7/25) · p+4.7pp cap37.5 net+24/med-1.0) |
...
- forward payoff: right +4848 / wrong -4317 / net +531 pts; median per fire -0.75 (n=224)
...
| session | backtest | forward |
|---|---|---|
| whole | ▼i-4.8pp (36/220) · p+2.5pp cap139.2 net-505/med-2.8 | ▲i+2.6pp (39/167) · p-0.2pp cap63.5 net+38/med-1.0 |
| london | ·i-0.5pp (12/50) · p-0.3pp cap126.8 net-218/med-18.0 | ▲i+5.0pp (14/54) · p-8.5pp cap85.8 net+64/med-5.8 |
| overlap | (°▼i-11.4pp (0/17) · p-3.3pp cap182.5 net-983/med-92.0) | (°▲i+6.8pp (2/12) · p-5.5pp cap185.5 net-58/med-44.5) |
| ny_only | ▼i-14.3pp (2/41) · p+30.3pp cap249.0 net+169/med-15.0 | ▲i+16.9pp (8/22) · p-5.4pp cap96.5 net-88/med+1.0 |
| dead | ▲i+4.8pp (6/31) · p+2.6pp cap99.5 net-162/med-5.0 | (°▲i+10.2pp (6/22) · p+5.8pp cap37.5 net+55/med+0.0) |
...
| session | backtest | forward |
|---|---|---|
| whole | (°▼i-21.2pp (0/4) · p+1.1pp cap81.0 net+59/med+13.2) | (°▼i-20.8pp (0/1) · p-23.6pp cap— net-13/med-13.0) |
...
| session | backtest | forward |
|---|---|---|
| whole | (°▼i-21.2pp (0/1) · p-23.9pp cap— net-135/med-135.0) | (°▼i-20.8pp (0/1) · p+76.4pp cap215.0 net+24/med+24.0) |
...
| session | backtest | forward |
|---|---|---|
| whole | ▼i-6.1pp (5/52) · p-21.3pp cap175.0 [cls 40.5%/15.7%i] net-1151/med-25.2 | ▲i+5.4pp (10/47) · p-1.0pp cap88.5 [cls 41.4%/15.9%i] net-597/med-14.5 |
| london | ·i+0.8pp (5/24) · p-28.4pp cap164.5 [cls 40.9%/20.0%i] net-664/med-30.0 | ·i-1.5pp (4/21) · p+24.5pp cap96.8 [cls 42.2%/20.5%i] net+380/med+26.5 |
| overlap | (°▼i-9.2pp (0/18) · p-18.9pp cap195.5 [cls 41.1%/9.2%i] net+234/med+6.8) | (°▲i+16.0pp (6/24) · p-19.6pp cap82.5 [cls 40.4%/9.0%i] net-914/med-40.2) |
| ny_only | (°▼i-5.4pp (0/6) · p+8.6pp cap329.0 [cls 41.4%/5.4%i] net-856/med-92.0) | — |
...
- forward payoff: right +876 / wrong -1473 / net -597 pts; median per fire -14.50 (n=47)
...
| session | backtest | forward |
|---|---|---|
| whole | ▲i+5.6pp (11/41) · p-1.9pp cap111.0 net+205/med-9.0 | ·i-1.4pp (7/36) · p+9.7pp cap70.0 net+386/med+4.8 |
| london | (°▲i+6.7pp (5/16) · p-5.1pp cap111.0 net-161/med-7.0) | (°▼i-8.4pp (1/8) · p-0.6pp cap71.5 net-141/med-32.0) |
| overlap | (°▼i-11.4pp (0/3) · p+34.0pp cap287.0 net+471/med+272.0) | (°▲i+10.1pp (1/5) · p+29.5pp cap198.5 net+322/med+112.0) |
| ny_only | (°▼i-19.2pp (0/4) · p-13.6pp cap— net-21/med-5.0) | (°▲i+5.5pp (2/8) · p-9.9pp cap— net+124/med+16.0) |
| dead | (°▲i+10.4pp (1/4) · p-7.1pp cap— net-1/med-2.0) | (°▲i+82.9pp (1/1) · p-3.3pp cap— net-0/med-0.5) |
...
- forward payoff: right +1158 / wrong -772 / net +386 pts; median per fire +4.75 (n=36)
...
| session | backtest | forward |
|---|---|---|
| whole | ·i-0.3pp (16/41) · p-3.1pp cap66.5 | ▼i-7.3pp (11/36) · p+10.8pp cap36.0 |
| london | (°▼i-14.0pp (5/16) · p+3.0pp cap60.5) | (°▼i-29.3pp (1/8) · p+28.3pp cap26.5) |
| overlap | (°▼i-22.8pp (0/3) · p+6.5pp cap287.0) | (°·i+1.4pp (1/5) · p+22.2pp cap191.2) |
| ny_only | (°▼i-10.1pp (1/4) · p-26.3pp cap—) | (°▲i+13.3pp (4/8) · p-19.9pp cap—) |
| dead | (°▲i+21.3pp (2/4) · p-14.3pp cap—) | (°▲i+69.5pp (1/1) · p-6.6pp cap—) |
...
| session | backtest | forward |
|---|---|---|
| whole | ▼i-13.3pp (73/281) · p+7.4pp cap76.5 | ▼i-4.0pp (76/224) · p+4.3pp cap42.5 |
| london | ▼i-6.5pp (24/62) · p+6.8pp cap60.5 | ▼i-5.8pp (32/89) · p-6.5pp cap58.8 |
| overlap | (°▼i-22.8pp (0/22) · p+21.6pp cap114.2) | (°▲i+6.4pp (3/12) · p+8.9pp cap62.2) |
| ny_only | ▼i-25.1pp (6/60) · p+37.0pp cap154.5 | ▲i+13.3pp (13/26) · p-8.4pp cap8.0 |
| dead | ▼i-11.6pp (7/41) · p+10.1pp cap10.5 | (°▲i+13.5pp (11/25) · p+1.4pp cap37.5) |
...
| session | backtest | forward |
|---|---|---|
| whole | ▼i-13.7pp (3/40) · p-1.4pp cap66.0 net-353/med-14.7 | ▼i-10.8pp (2/20) · p-13.6pp cap169.5 net-558/med-31.0 |
...
| ny_only | (°▼i-9.2pp (1/10) · p-3.6pp cap464.5 net-196/med-66.5) | (°▼i-19.5pp (0/5) · p-9.9pp cap— net-78/med-13.0) |
| dead | (°▼i-14.6pp (0/7) · p-7.1pp cap— net+60/med+15.5) | (°▼i-17.1pp (0/2) · p-3.3pp cap— net-4/med-3.5) |
...
| session | backtest | forward |
|---|---|---|
| whole | (°▼i-21.2pp (0/9) · p-1.7pp cap273.0 net+460/med+1.5) | (°▼i-2.6pp (2/11) · p-5.4pp cap169.5 net-375/med-31.0) |
| london | (°▼i-24.5pp (0/1) · p-36.3pp cap— net-38/med-38.0) | (°▲i+4.1pp (2/8) · p-13.1pp cap169.5 net-305/med-84.8) |
| overlap | — | — |
| ny_only | (°▼i-19.2pp (0/4) · p+11.4pp cap464.5 net+421/med+15.3) | (°▼i-19.5pp (0/2) · p-9.9pp cap— net-41/med-20.5) |
| dead | — | — |
...
| session | backtest | forward |
|---|---|---|
| whole | ·i-1.7pp (30/154) · p+1.4pp cap71.0 net+1774/med+11.0 | ▼i-4.8pp (25/156) · p-3.7pp cap56.5 net+230/med-0.5 |
| london | ▼i-19.5pp (2/40) · p+3.7pp cap116.0 net+1480/med+27.5 | ▲i+3.5pp (10/41) · p-4.0pp cap80.5 net+196/med-11.0 |
| overlap | (°▼i-11.4pp (0/5) · p-32.7pp cap— net+36/med+33.0) | (°▼i-9.9pp (0/1) · p-30.5pp cap— net+72/med+71.5) |
| ny_only | ▼i-3.8pp (4/26) · p+9.5pp cap79.4 net-348/med+48.8 | ▼i-7.0pp (6/48) · p-5.7pp cap98.0 net-509/med-5.5 |
| dead | ▲i+15.4pp (6/20) · p-7.1pp cap— net-74/med-5.7 | (°▼i-8.0pp (2/22) · p-3.3pp cap— net-64/med-3.2) |
...
| session | backtest | forward |
|---|---|---|
| whole | ·i-0.4pp (86/413) · p+3.5pp cap98.0 net+1254/med+3.0 | ·i+0.4pp (65/306) · p+3.2pp cap65.2 net-370/med-5.0 |
| london | ▼i-5.5pp (31/163) · p+1.1pp cap91.0 net-404/med+5.0 | ▼i-2.3pp (24/129) · p-0.9pp cap75.0 net+175/med+0.0 |
| overlap | (°▼i-7.6pp (1/26) · p+21.1pp cap261.2 net+491/med+4.0) | (°▼i-6.8pp (1/32) · p-2.4pp cap128.5 net+215/med+5.5) |
| ny_only | ▲i+9.4pp (12/42) · p-1.7pp cap239.5 net+1037/med+15.2 | ·i-1.3pp (4/22) · p-0.8pp cap75.5 net-270/med-7.8 |
| dead | ▼i-6.6pp (4/50) · p+14.9pp cap99.5 net+478/med+1.2 | (°▼i-5.1pp (3/25) · p-3.3pp cap— net-217/med-7.0) |
...
- forward payoff: right +5234 / wrong -5604 / net -370 pts; median per fire -5.00 (n=306)
